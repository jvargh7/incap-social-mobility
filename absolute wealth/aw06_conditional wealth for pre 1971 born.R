...
'
result_cwealth1987 <- with(miaux_dfs67,lm(as.formula(model_cwealth1987)))
...
'
result_cwealth2002 <- with(miaux_dfs67,lm(as.formula(model_cwealth2002)))
...
'
result_cwealth1618 <- with(miaux_dfs67,lm(as.formula(model_cwealth1618)))
